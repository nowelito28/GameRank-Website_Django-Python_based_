...
SVC_NAME="actions.runner.nowelito28-GameRank-Website_Django-Python_based_.gamerank-runner"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (nowelito28-GameRank-Website_Django-Python_based_.gamerank-runner)"
